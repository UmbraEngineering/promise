...
Promise.prototype.then = function(onResolve, onReject) {
	...
	// Otherwise, add the functions to the list
		...
		this.funcs.push(promise,
			function() {
				return invokeFunction(self, promise, onResolve);
			},
			function(value) {
				return invokeFunction(self, promise, onReject);
			}
		);
	}
...
function rejectPromise(promise, value) {
	startCompletion(promise, FAILED, value);
}
...
// @param {state} the state to set (FULFILLED or FAILED)
// @param {value} the value of the promise
// @return void
// 
